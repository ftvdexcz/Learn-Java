...
public class FormBanDoc extends javax.swing.JPanel {
    ...
    public FormBanDoc() {
        initComponents();
        setSize(1000, 850);
        String[] cols = {"Mã bạn đọc", "Họ tên", "Địa chỉ", "SDT"};
        model = new DefaultTableModel(cols, 0);
        jTable1.setModel(model);
        buttonState(true);
        them = false;
        sua = false;
        fbandoc = "src/de1/controller/bandoc.txt";
        loadData();
    }
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if (them) {
            ...
            try {
                ...
                if (!sdt.matches("\\d+")) throw new SDTException();
                int maBanDoc = Integer.parseInt(jTextField1.getText());
                BanDoc s = new BanDoc(maBanDoc, ten, diachi, sdt);
        ...
        if (sua) {
            ...
            BanDoc s = new BanDoc(ma, ten, diachi, sdt);
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        if (row == -1 || row > jTable1.getRowCount() - 1) {
            JOptionPane.showMessageDialog(this, "Chọn bạn đọc để xóa");
        } else {
            model.removeRow(row);
            lbandoc.remove(row);
        }
